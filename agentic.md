# Agent Operating Charter — Refund Support Agent

> This file is **Layer 1: Instructions** of the harness. It is the contract every other layer reads from. Loaded into the system prompt at agent boot. Versioned in git. Mirrored to Langfuse for runtime hot-reload.
...
`agentic.md@v1` — drafted 2026-06-18. Changes require a corresponding ADR in `docs/decisions/`.
